    ...
    <Container size={"60%"}>
      <Box>
        ...
        <Text pt={"1rem"} size="lg">
          ...
          industry the job is in our Team will present you with a diverse slate
        ...
        <Text pt={"1rem"} size="lg">
          ...
          Associate team to begin finding candidates that will not only have the
          skills needed to excel in the role but will also be a match for your
          organization's own unique culture.
        </Text>
        <Text pt={"1rem"} size="lg">
          ...
          team contacts them directly to determine their interest and their fit
          for your opportunity. This intensive process generates the best
      ...
      <Box>
        ...
        <Text pt={"1rem"} size="lg">
          Reffett Associates believes that diversity in the workforce should be
          a priority of all organizations. With every executive search
          assignment, our firm makes a conscious effort to contact, develop and
          present a slate of candidates who represent every race, gender, ethnic
          background, physical challenge, religion, sexual orientation and age.
        </Text>
        <Text pt={"1rem"} size="lg">
          ...
          all research, interview notes, background checks and reference checks
          conducted to ensure that all information is readily available should
        ...
        <Text pt={"1rem"} size="lg">
          ...
          national origin, and in instances where that information is disclosed
          in the course of the search process, we will not allow it have any
          bearing on a candidate's ability to progress through the search
          process.
        </Text>
      </Box>
      <Box>
        ...
        <Text pt={"1rem"} size="lg">
          ...
          equitable search practices. We recognize that often, and particularly
          for leadership positions, there are systemic barriers that prevent
          potential applicants from being aware of an opportunity or be willing
          to apply for a potential opportunity. Through our recruitment process
          we seek to ensure that any barriers to potential candidates or search
          techniques that exist that would artificially limit our pool of
          potential candidates are identified and eliminated to create the
          broadest possible applicant pool for our Client.
        </Text>
      </Box>
      <Box>
        <Title order={2} style={{ textAlign: "center" }}>
