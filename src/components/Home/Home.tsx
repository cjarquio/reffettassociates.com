...
export const Home: React.FC = () => {
  return (
    <Box className={classes.root}>
      ...
      <Container fluid className={classes.executiveSearch}>
      ...
      <Container fluid className={classes.veterans}>
        <Group justify={"flex-end"} gap={"sm"} style={{ flexWrap: "nowrap" }}>
          <Title c={"white"} order={4} className={classes.veteransDescription}>
